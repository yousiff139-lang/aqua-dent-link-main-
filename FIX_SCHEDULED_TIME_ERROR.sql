-- ============================================================================
-- FIX "invalid input syntax for type time: 'scheduled time'" ERROR
-- The issue is in notification messages using placeholder text
-- ============================================================================

-- Update the notification trigger to handle NULL times properly
...
DECLARE
  ...
  v_date_display TEXT;
BEGIN
  -- Format time for display (not for database storage)
...
-- Also update the cancel function to use proper time handling
...
-- Verification
SELECT 'Time handling fixed! No more "scheduled time" errors.' as status;
