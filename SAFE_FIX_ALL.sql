-- ============================================================================
-- SAFE FIX - Handles existing objects gracefully
-- Run this if you get "already exists" errors
-- ============================================================================

-- Step 1: Fix Notifications RLS (DROP first to avoid conflicts)
...
-- Step 2: Add appointment type columns (IF NOT EXISTS)
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- Step 3: Create appointment_types table (IF NOT EXISTS)
...
-- Step 4: Insert appointment types (ON CONFLICT DO NOTHING)
...
-- Step 5: Create/Replace cancel appointment function
...
-- Step 6: Fix dentist portal RLS (DROP first)
...
-- Step 7: Update notification trigger (CREATE OR REPLACE)
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Appointment types available: %', v_appointment_types_count;
  RAISE NOTICE 'Notification trigger updated';
  RAISE NOTICE 'Cancel function created';
